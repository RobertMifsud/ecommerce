...
function addFeatured($products)
{
    ...
    for (var $productIndex = 0; $productIndex < $products.length; $productIndex++)
    {
        var $featureditem = "<div class='item' id=featured"+ $productIndex+">" +
            "<a href='/products/index.php?product="+$products[$productIndex]._id.$oid+"'><img src='http://backend.dev/files/" + $products[$productIndex].image[0] + "' alt='" + $products[$productIndex].name + "'></a>" +
            "<p class='bold dark-green-color'>"+$products[$productIndex].name+"</p><p class='dark-green-color'>&euro;"+$products[$productIndex].price+"</p></div>";
